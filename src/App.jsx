...
function Welcome({ onStart }) {
  ...
  return (
    <div style={{ padding:"24px 16px 32px", maxWidth:580, margin:"0 auto" }}>
      ...
      {/* 3 sections nouvelles questions */}
...
export default function App() {
  ...
  // Force layout on all ancestor elements so the app fills the viewport
  useEffect(() => {
    ...
    // Walk up from root and force each ancestor to fill the viewport
